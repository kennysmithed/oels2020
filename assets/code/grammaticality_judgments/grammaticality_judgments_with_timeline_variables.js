...
// Stitch the two together - use the sentences variable to fill in the
...
var instruction_screen_1 = {
  ...
  <p>In this experiment you will read English sentences, and determine if they sound \
  ...
  <p>We are <b>not</b> concerned with whether the sentence would be graded highly \
...
var instruction_screen_2 = {
  ...
  <p>For each sentence, simply press the <b>y</b> key (for yes) if you think the sentence \
  ...
  <p>Here are two examples: the first is a <b>no</b> for most speakers, and the \
  second is a <b>yes</b> for most speakers.</p>\
  <p> The was insulted waitress frequently <b>(no)</b></p>\
  <p> This is a pen <b>(yes)</b></p>\
