...
For the practical component of week 2 (linked from the course page) we'll help you get set up with jspsych, and learn enough of the basics so we can jump in to building simple experiments in week 3.
...
See above on cost - assuming you are paying your participants fairly, online experiments should be relatively expensive, not cheap, although	if you normally employ people to collect face-to-face data you need to factor in the time saved there.
