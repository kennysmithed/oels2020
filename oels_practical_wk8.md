...
Then click the "action" button (with the cog), select the "New folder..." option and call it audio. That should create a folder in the correct place with the correct permissions!
